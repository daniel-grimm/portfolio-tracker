...
interface HoldingRowProps {
  holding: HoldingMetadata;
  onEdit: (holding: HoldingMetadata) => void;
  ...
  return (
    <TableRow hover>
      ...
      <TableCell align="right">
        {formatCurrency(holding.stockData.currentPrice)}
      </TableCell>
      <TableCell align="right">
      ...
      <TableCell
        align="right"
        sx={{ color: getGainLossColor(holding.gainLoss) }}
      >
        {formatCurrency(holding.gainLoss)}
      </TableCell>
      <TableCell
        align="right"
        sx={{ color: getGainLossColor(holding.gainLossPercent) }}
      >
